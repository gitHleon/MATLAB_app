...
%             State2 = ACS.SPiiPlusNET.MotorStates.ACSC_MST_ENABLE
        ...
        function Move2Fast(this, varargin)
            % function MoveToFast (this, X, Y)
            % Arguments: X double, Y double, wait int
            % (0-> Wait until movement finishes, 1-> No wait
            % Return: none
            ...
            this.zSecurityPosition();
            this.MoveTo(this.X,p.Position{this.vec.X},p.Velocity)
            this.MoveTo(this.Y,p.Position{this.vec.Y},p.Velocity)
            this.WaitForMotionAll();
            
            this.MoveTo(this.U,p.Position{this.vec.U},p.Velocity)
            this.MoveTo(this.Z1,p.Position{this.vec.Z1},p.Velocity)
            this.MoveTo(this.Z2,p.Position{this.vec.Z2},p.Velocity)
